...
import PatientAppointments from "./patient/PatientAppointments"; // Added import
import CurrentTime from "./CurrentTime";

const menu = [
    { name: "Dashboard", icon: LayoutDashboard, id: "dashboard" },
    { name: "Appointments", icon: Calendar, id: "appointments" }, // Added menu item
...
export default function PatientDashboard({ patientName = "Rahul Sharma", userId: patientId, onLogout }) {
    ...
    return (
        <div className="min-h-screen bg-[#f8f9fc] text-gray-900 font-sans flex">
            {/* Sidebar */}
            <aside className="hidden lg:flex w-72 flex-col border-r border-gray-200 bg-white sticky top-0 h-screen">
