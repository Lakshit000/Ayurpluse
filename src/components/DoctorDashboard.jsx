...
export default function DoctorDashboard({ doctorName = "Dr. Aditi Kulkarni", userId = 1, onLogout }) {
    ...
    return (
        <div className="min-h-screen bg-[#f6f7fb] text-gray-900 font-sans selection:bg-emerald-100 selection:text-emerald-900">
            <div className="flex min-h-screen">
                {/* Sidebar */}
                <aside className="hidden lg:flex w-72 flex-col border-r border-gray-200 bg-white/80 backdrop-blur-md sticky top-0 h-screen z-40">
                ...
                {/* Main */}
                <main className="flex-1 min-w-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')]">
                    {/* Topbar */}
